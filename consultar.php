    	...
    	<nav class="navbar navbar-expand-lg navbar-light bg-primary">
		  ...
		  <div class="collapse navbar-collapse" id="navbarNavDropdown">
		    <ul class="navbar-nav">
		      ...
		      <li class="nav-item">
		        <a class="nav-link" href="#"><i class="fas fa-address-book"></i> Consultar Registros</a>
		      </li>
		      <li class="nav-item">
			...
			<table class="table table-striped table-dark">
			  ...
			  <tbody>
			   ...
			   <tr>
			      ...
			      <td> <a class="btn btn-primary" href="editar.php?idUsuario='<?php echo $mostrar['idUsuario'];?>'"><i class="fas fa-cog"></i></a>
