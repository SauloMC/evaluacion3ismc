<!DOCTYPE html>
		  ...
		  <div class="collapse navbar-collapse" id="navbarNavDropdown">
		    <ul class="navbar-nav">
		      ...
		      <li class="nav-item active">
		        <a class="nav-link" href="#"><i class="fas fa-solid fa-user"></i> &nbsp;Registrar Usuario</a>
		      </li>
		      <li class="nav-item">
	...
	<body>
        ...
        <div class = "container-fluid">
            <form method="POST" action="registrar.php" class = "was-validated" novalidate>
               <!--<div class="form-row">-->
                ...
                <input class="form-control" list="datalistOptions1" name="pais" id="pais" placeholder="Escribe para buscar..." required>
                ...
                <div class="form-group">
                 ...
                 <input class="form-control" list="datalistOptions2" name="tipoSangre" id="tipoSangre" placeholder="Tipo de sangre" required>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="contactoEm" id="contactoEm" placeholder="Contacto de emergencia" required>
                  <div class="valid-feedback">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="telConEm" id="telConEm" placeholder="Telefono de contacto de emergencia" required>
                  <div class="valid-feedback">
                  Teléfono válido.
                </div>
                <div class="invalid-feedback">
                ...
                <div class="form-group">	
                  ...
                  <input type="text" class="form-control" name="enfermedad" id="enfermedad" placeholder="Alguna enfermedad que mencionar">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="alergia" id="alergia" placeholder="Alguna alergia que mencionar">
                 ...
                 <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="fechanac" id="fechanac" value="02-12-1969" min="2-12-1969" max="2-12-2003" required>
                 </div>
                  <div class="form-group">
                  <label for="vigencia">Vigencia:  </label>
                  <input type="date" class="form-control" name="vigencia" id="vigencia" value="02-12-2021" min="02-12-2021" max="02-12-2030" required>
                 </div>
              </div><br>
              <div class="col-xs-7">
              <input name="guardar" type="submit" value="Guardar" class = "btn btn-primary btn-lg">
              </div>
          </form>
        </div>
        </main>
