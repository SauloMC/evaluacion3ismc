		  ...
		  <div class="collapse navbar-collapse" id="navbarNavDropdown">
		    <ul class="navbar-nav">
		      ...
		      <li class="nav-item active">
          		<a class="nav-link" href="#"><i class="fas fa-address-card"></i> Imprimir Credencial</a>
         	  </li>
		    </ul>
		  </div>
		</nav>
			...
			<table class="table table-striped table-dark">
			  ...
			  <tbody>
			   ...
			   <tr>
			      ...
			      <td> <a class="btn btn-primary" href="imprimirCredencial.php?idUsuario='<?php echo $mostrar['idUsuario'];?>'"><i class="far fa-id-card"></i></a>
